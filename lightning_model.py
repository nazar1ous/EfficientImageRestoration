...
from GoPro_deblur_dataset import PairedImageDataset
...
from basicsr.models.archs.NAFNet_with_soft_attention_arch import SoftANAFNetLocal
...
# def get_model(class_route, params):
#     if name == "NAFNetLocal":
#         model = NAFNetLocal(**params)
#     elif name == "SoftANAFNetLocal":
#         model = SoftANAFNetLocal(**params)
#     return model

# def get_loss(loss, lam):
#     return PSNRLoss(**params)
