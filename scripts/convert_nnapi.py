...
def make_mobilenetv2_nnapi(output_dir_path, quantize_mode):
    ...
    # Save both models.
    model._save_for_lite_interpreter("mobilenetv2-quant_{}-cpu.pt".format(quantize_mode))
    nnapi_model._save_for_lite_interpreter("mobilenetv2-quant_{}-nnapi.pt".format(quantize_mode))


if __name__ == "__main__":
    for quantize_mode in ["none", "core", "full"]:
        make_mobilenetv2_nnapi("mobilenetv2-nnapi", "core")