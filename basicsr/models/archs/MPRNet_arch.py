...
# ------------------------------------------------------------------------
# Modified from MPRNet (https://github.com/swz30/MPRNet/blob/main/Deblurring/MPRNet.py)
# Copyright 2018-2020 MPRNet Authors
# ------------------------------------------------------------------------
"""
...
class MPRNetLocal(Local_Base, MPRNet):
    def __init__(self, *args, base_size, train_size=(1, 3, 256, 256), fast_imp=False, **kwargs):
